    ...
    <>
      <div className='policy'>
        <div className='policy__container'>
          ...
          <p>
            <strong>Coralyze</strong> is committed to providing quality services
            to you and this policy outlines our ongoing obligations to you in
            respect of how we manage your Personal Information. <br />
            ...
            <strong>
              by email, via our website www.coralyze.com, from cookies, from
              media and publications, from other publicly available sources
            </strong>
            , and from third party applications. We don’t guarantee website
            ...
            <br />
            Coralyze will not charge any fee for your access request, but may
            ...
            <br />
            <br />
            33 Moore Street Liverpool NSW 2162
            <br />
